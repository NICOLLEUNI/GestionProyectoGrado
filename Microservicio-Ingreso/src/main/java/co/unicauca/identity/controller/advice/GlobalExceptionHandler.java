package co.unicauca.identity.controller.advice;
    ...
    public ResponseEntity<ApiResponse<Void>> handleHttpMessageNotReadable(
        ...
        if (exMessage != null) {
            if (exMessage.contains("Programa")) {
                ...
                message = "Valor inválido para 'rol'. Valores válidos: ESTUDIANTE, DOCENTE, COORDINADOR, JEFE_DEPARTAMENTO";
            } else if (exMessage.contains("Departamento")) {
                message = "Valor inválido para 'departamento'. Valores válidos: SISTEMAS, ELECTRONICA, TELECOMUNICACIONES, TELEMATICA, AUTOMATICA_INDUSTRIAL";

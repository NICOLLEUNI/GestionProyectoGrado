...
private Set<EnumRol> obtenerRolesSeleccionados() {
    ...
    if (CBECoordinador1.isSelected() || CBECoordinador2.isSelected()) {
...
public static void main(String args[]) {
    ...
    try {
        ...
        java.util.logging.Logger.getLogger(GUISing_In.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
